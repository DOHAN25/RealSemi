...
<div class="Menu" id="left">
			...
			<div class="sidebar" id="sidebar_all">
				<br><div class="leftMenu" id="subMenu"> <a href="login.jsp"> 로그인 / 회원가입</a> <!-- 로그인페이지 --></div>
	...
	<br><br><br><br><div class="leftMenu" id="subMenu"> <a href="support.jsp"> ☞ 후원하기 </a></div><br> <!-- 결제api연결하기 -->
</div>
